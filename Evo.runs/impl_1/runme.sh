...
HD_PWD='C:/Projet/Vivado/Evo/Evo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log evo_v1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source evo_v1_wrapper.tcl -notrace
