...
HD_PWD='C:/Projet/Vivado/Evo/Evo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log evo_v1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source evo_v1_wrapper.tcl
