...
HD_PWD='C:/Projet/Vivado/Evo/Evo.runs/evo_v1_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log evo_v1_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source evo_v1_auto_pc_0.tcl
