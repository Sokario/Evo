...
##Switches
##IO_L19N_T3_VREF_35
#set_property PACKAGE_PIN G15 [get_ports {Gpio_IRQ[0]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {Gpio_IRQ[0]}]

##IO_L24P_T3_34
#set_property PACKAGE_PIN P15 [get_ports {Gpio_IRQ[1]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {Gpio_IRQ[1]}]

##IO_L4N_T0_34
#set_property PACKAGE_PIN W13 [get_ports {Gpio_IRQ[2]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {Gpio_IRQ[2]}]

##IO_L9P_T1_DQS_34
#set_property PACKAGE_PIN T16 [get_ports {Gpio_IRQ[3]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {Gpio_IRQ[3]}]

##Buttons
##IO_L20N_T3_34
#set_property PACKAGE_PIN R18 [get_ports {Gpio_IRQ[0]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {Gpio_IRQ[0]}]

##IO_L24N_T3_34
#set_property PACKAGE_PIN P16 [get_ports {Gpio_IRQ[1]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {Gpio_IRQ[1]}]

##IO_L18P_T2_34
#set_property PACKAGE_PIN V16 [get_ports {Gpio_IRQ[2]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {Gpio_IRQ[2]}]

##IO_L7P_T1_34
#set_property PACKAGE_PIN Y16 [get_ports {Gpio_IRQ[3]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {Gpio_IRQ[3]}]
