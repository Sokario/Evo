...
architecture STRUCTURE of evo_v1_Gpio_IRQ_0_0_Gpio_IRQ_v1_0_S00_AXI is
  ...
  signal counter_i_reg : STD_LOGIC_VECTOR ( 18 downto 0 );
  ...
  signal \NLW_counter_i_reg[16]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_counter_i_reg[16]_i_1_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
...
\counter_i0_carry__0_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
...
\counter_i0_carry__1_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
...
\counter_i_reg[16]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 2) => \NLW_counter_i_reg[16]_i_1_CO_UNCONNECTED\(3 downto 2),
      CO(1) => \counter_i_reg[16]_i_1_n_2\,
      CO(0) => \counter_i_reg[16]_i_1_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3) => \NLW_counter_i_reg[16]_i_1_O_UNCONNECTED\(3),
      O(2) => \counter_i_reg[16]_i_1_n_5\,
      O(1) => \counter_i_reg[16]_i_1_n_6\,
      O(0) => \counter_i_reg[16]_i_1_n_7\,
      S(3) => '0',
      S(2) => \counter_i[16]_i_2_n_0\,
      S(1) => \counter_i[16]_i_3_n_0\,
      S(0) => \counter_i[16]_i_4_n_0\
    );
