...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Gpio_IRQ_v1_0_S00_AXI is
  ...
  signal \counter_i0_inferred__0/i__carry__0_n_0\ : STD_LOGIC;
  signal \counter_i0_inferred__0/i__carry__0_n_1\ : STD_LOGIC;
  signal \counter_i0_inferred__0/i__carry__0_n_2\ : STD_LOGIC;
  signal \counter_i0_inferred__0/i__carry__0_n_3\ : STD_LOGIC;
  signal \counter_i0_inferred__0/i__carry__1_n_3\ : STD_LOGIC;
  signal \counter_i0_inferred__0/i__carry_n_0\ : STD_LOGIC;
  signal \counter_i0_inferred__0/i__carry_n_1\ : STD_LOGIC;
  signal \counter_i0_inferred__0/i__carry_n_2\ : STD_LOGIC;
  signal \counter_i0_inferred__0/i__carry_n_3\ : STD_LOGIC;
  ...
  signal \counter_i[6]_i_2_n_0\ : STD_LOGIC;
  signal \counter_i_reg__0\ : STD_LOGIC_VECTOR ( 6 downto 0 );
  ...
  signal \NLW_counter_i0_inferred__0/i__carry_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_counter_i0_inferred__0/i__carry__0_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_counter_i0_inferred__0/i__carry__1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_counter_i0_inferred__0/i__carry__1_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute SOFT_HLUTNM of \axi_rdata[2]_i_4\ : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of \counter_i[0]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \counter_i[1]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \counter_i[2]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \counter_i[3]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \counter_i[4]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \counter_i[6]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \last_i[0]_i_1\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \last_i[3]_i_2\ : label is "soft_lutpair5";
...
\counter_i0_inferred__0/i__carry\: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => \counter_i0_inferred__0/i__carry_n_0\,
      CO(2) => \counter_i0_inferred__0/i__carry_n_1\,
      CO(1) => \counter_i0_inferred__0/i__carry_n_2\,
      CO(0) => \counter_i0_inferred__0/i__carry_n_3\,
      CYINIT => '1',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => \NLW_counter_i0_inferred__0/i__carry_O_UNCONNECTED\(3 downto 0),
      S(3) => \i__carry_i_1_n_0\,
      S(2) => \i__carry_i_2_n_0\,
      S(1) => \i__carry_i_3_n_0\,
      S(0) => \i__carry_i_4_n_0\
    );
\counter_i0_inferred__0/i__carry__0\: unisim.vcomponents.CARRY4
     port map (
      CI => \counter_i0_inferred__0/i__carry_n_0\,
      CO(3) => \counter_i0_inferred__0/i__carry__0_n_0\,
      CO(2) => \counter_i0_inferred__0/i__carry__0_n_1\,
      CO(1) => \counter_i0_inferred__0/i__carry__0_n_2\,
      CO(0) => \counter_i0_inferred__0/i__carry__0_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => \NLW_counter_i0_inferred__0/i__carry__0_O_UNCONNECTED\(3 downto 0),
      S(3) => \i__carry__0_i_1_n_0\,
      S(2) => \i__carry__0_i_2_n_0\,
      S(1) => \i__carry__0_i_3_n_0\,
      S(0) => \i__carry__0_i_4_n_0\
    );
\counter_i0_inferred__0/i__carry__1\: unisim.vcomponents.CARRY4
     port map (
      CI => \counter_i0_inferred__0/i__carry__0_n_0\,
      CO(3 downto 2) => \NLW_counter_i0_inferred__0/i__carry__1_CO_UNCONNECTED\(3 downto 2),
      CO(1) => enable_i,
      CO(0) => \counter_i0_inferred__0/i__carry__1_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => \NLW_counter_i0_inferred__0/i__carry__1_O_UNCONNECTED\(3 downto 0),
      S(3 downto 2) => B"00",
...
\counter_i[0]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
        ...
        port map (
      I0 => \counter_i_reg__0\(0),
      O => \p_0_in__0\(0)
    );
\counter_i[1]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
      I0 => \counter_i_reg__0\(0),
      I1 => \counter_i_reg__0\(1),
      O => \p_0_in__0\(1)
    );
\counter_i[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"78"
    )
        port map (
      I0 => \counter_i_reg__0\(0),
      I1 => \counter_i_reg__0\(1),
      I2 => \counter_i_reg__0\(2),
      O => \p_0_in__0\(2)
    );
\counter_i[3]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7F80"
    )
        port map (
      I0 => \counter_i_reg__0\(1),
      I1 => \counter_i_reg__0\(0),
      I2 => \counter_i_reg__0\(2),
      I3 => \counter_i_reg__0\(3),
      O => \p_0_in__0\(3)
    );
\counter_i[4]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFF8000"
    )
        port map (
      I0 => \counter_i_reg__0\(2),
      I1 => \counter_i_reg__0\(0),
      I2 => \counter_i_reg__0\(1),
      I3 => \counter_i_reg__0\(3),
      I4 => \counter_i_reg__0\(4),
      O => \p_0_in__0\(4)
    );
\counter_i[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"7FFFFFFF80000000"
    )
        port map (
      I0 => \counter_i_reg__0\(3),
      I1 => \counter_i_reg__0\(1),
      I2 => \counter_i_reg__0\(0),
      I3 => \counter_i_reg__0\(2),
      I4 => \counter_i_reg__0\(4),
      I5 => \counter_i_reg__0\(5),
      O => \p_0_in__0\(5)
    );
\counter_i[6]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"78"
    )
        port map (
      I0 => \counter_i[6]_i_2_n_0\,
      I1 => \counter_i_reg__0\(5),
      I2 => \counter_i_reg__0\(6),
      O => \p_0_in__0\(6)
    );
\counter_i[6]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80000000"
    )
        port map (
      I0 => \counter_i_reg__0\(4),
      I1 => \counter_i_reg__0\(2),
      I2 => \counter_i_reg__0\(0),
      I3 => \counter_i_reg__0\(1),
      I4 => \counter_i_reg__0\(3),
      O => \counter_i[6]_i_2_n_0\
    );
...
\i__carry_i_3\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => counter_i1(3),
      I2 => counter_i1(5),
      I3 => \counter_i_reg__0\(5),
      I4 => counter_i1(4),
      I5 => \counter_i_reg__0\(4),
      O => \i__carry_i_3_n_0\
    );
\i__carry_i_4\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \counter_i_reg__0\(2),
      I4 => counter_i1(1),
      I5 => \counter_i_reg__0\(1),
      O => \i__carry_i_4_n_0\
    );
interrupt_i_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000FFFF45400000"
    )
        port map (
      I0 => \last_i_reg_n_0_[3]\,
      I1 => slv_reg2(3),
...
\slv_reg1[26]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
