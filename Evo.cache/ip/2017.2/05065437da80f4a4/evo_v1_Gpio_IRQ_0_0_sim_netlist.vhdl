...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Gpio_IRQ_v1_0_S00_AXI is
  ...
  signal \counter_i[18]_i_9_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \axi_rdata[26]_i_3\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \axi_rdata[26]_i_4\ : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of \axi_rdata[3]_i_4\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \counter_i[0]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \counter_i[18]_i_4\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \last_i[0]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \last_i[2]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \last_i[3]_i_2\ : label is "soft_lutpair4";
...
\counter_i[18]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000004"
        ...
        port map (
      I0 => \counter_i[18]_i_3_n_0\,
      I1 => \counter_i[18]_i_4_n_0\,
      I2 => \counter_i[18]_i_5_n_0\,
      I3 => \counter_i[18]_i_6_n_0\,
      I4 => \counter_i[18]_i_7_n_0\,
      O => enable_i
    );
\counter_i[18]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"DFFF"
    )
        port map (
...
\counter_i[18]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0010"
    )
        port map (
...
\counter_i[18]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFF7"
    )
        port map (
...
\counter_i[18]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"DFFF"
    )
        port map (
...
\counter_i[18]_i_7\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"BF"
    )
        port map (
...
\counter_i[18]_i_8\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
\counter_i[18]_i_9\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
      I0 => counter_i(17),
      O => \counter_i[18]_i_9_n_0\
    );
...
\counter_i_reg[18]_i_2\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 2) => B"00",
      S(1) => \counter_i[18]_i_8_n_0\,
      S(0) => \counter_i[18]_i_9_n_0\
    );
