...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Gpio_IRQ_v1_0_S00_AXI is
  ...
  signal gpio_i : STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute SOFT_HLUTNM of \slv_reg1[3]_i_2\ : label is "soft_lutpair1";
begin
  Interrupt <= \^interrupt\;
...
interrupt_i_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"008E"
    )
        port map (
      I0 => interrupt_i_i_2_n_0,
      I1 => gpio_i(3),
      I2 => last_i(3),
      I3 => \^interrupt\,
      O => interrupt_i
